...
bfs()
max_relief = 0
for path_1 in max_paths:
    for path_2 in max_paths:
        if path_1.isdisjoint(path_2):
            max_relief = max(max_relief, max_paths[path_1] + max_paths[path_2])
print(max_relief)